...
[![Read the Docs](https://img.shields.io/readthedocs/gpce-model?style=flat&logo=readthedocs)](https://gpce-model.readthedocs.io/en/latest/)
[![PyPI - Version](https://img.shields.io/pypi/v/gPCE-model?style=flat)](https://pypi.org/project/gPCE-model/)
